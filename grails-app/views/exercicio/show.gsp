	...
	<body>
		...
		<div id="show-exercicio" class="content scaffold-show" role="main">
			...
			<ol class="property-list exercicio">
				...
				<g:if test="${exercicioInstance?.grupoMuscular}">
				<li class="fieldcontain">
					<span id="grupoMuscular-label" class="property-label"><g:message code="exercicio.grupoMuscular.label" default="Grupo Muscular" /></span>
					
						<span class="property-value" aria-labelledby="grupoMuscular-label"><g:link controller="grupoMuscular" action="show" id="${exercicioInstance?.grupoMuscular?.id}">${exercicioInstance?.grupoMuscular?.encodeAsHTML()}</g:link></span>
			...
			<g:form>
				<fieldset class="buttons">
					<g:hiddenField name="id" value="${exercicioInstance?.id}" />
					<g:link class="edit" action="edit" id="${exercicioInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
