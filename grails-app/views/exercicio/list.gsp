	...
	<body>
		...
		<div id="list-exercicio" class="content scaffold-list" role="main">
			...
			<table>
				<thead>
					<tr>
						...
						<th><g:message code="exercicio.grupoMuscular.label" default="Grupo Muscular" /></th>
				...
				<g:each in="${exercicioInstanceList}" status="i" var="exercicioInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: exercicioInstance, field: "grupoMuscular")}</td>
			...
			<div class="pagination">
				<g:paginate total="${exercicioInstanceTotal}" />
			</div>
		</div>
	</body>
</html>
