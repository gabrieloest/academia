	...
	<body>
		...
		<div id="show-patrocinador" class="content scaffold-show" role="main">
			...
			<ol class="property-list patrocinador">
				...
				<g:if test="${patrocinadorInstance?.foto}">
				<li class="fieldcontain">
					<span id="foto-label" class="property-label"><g:message code="patrocinador.foto.label" default="Foto" /></span>
			...
			<g:form>
				<fieldset class="buttons">
					<g:hiddenField name="id" value="${patrocinadorInstance?.id}" />
					<g:link class="edit" action="edit" id="${patrocinadorInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
